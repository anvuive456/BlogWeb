    ...
    <>
      <MotionDiv variants={variants} initial='hidden' animate='visible'
        ...
        <div className='relative h-full'>
          ...
          <p
            className='line-clamp-3 text-gray-900 font-thin tracking-wider leading-tight max-sm:text-sm'>{post.description}...</p>
          <AppDate className='max-sm:text-sm font-light absolute bottom-0' dateString={post.updatedAt.toString()} />
          {/*<a href={post.url}*/}
