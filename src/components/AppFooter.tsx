        ...
        <div className='max-w-5xl mx-auto pb-10 pt-10 text-gray-900'>
          ...
          <div className='sm:flex px-3'>
            ...
            <div className='w-full sm:w-1/2 text-center md:text-right mt-10 sm:mt-0'>
              <Link target='_blank' href='https://www.facebook.com/profile.php?id=100003962274819' title='Facebook'
                    className='inline-block w-6 mr-2'>
                <Icons.facebook />
              </Link>
              <Link target='_blank' href='https://www.linkedin.com/in/trannhatan280399' title='LinkedIn'
                    className='inline-block w-6 mr-2'>
                <Icons.linkedin />
              </Link>
              <Link target='_blank' href='https://www.instagram.com/mr_an_283' title='Instagram'
