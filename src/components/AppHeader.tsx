            ...
            <header className="max-w-5xl mx-auto pt-5">
                <div className="flex flex-wrap -mx-2 overflow-hidden px-5 lg:px-2 my-2">
                    ...
                    <div className="my-2 px-2 w-full overflow-hidden md:w-2/6 lg:w-1/3 xl:w-1/3 text-center md:text-right">
                        <Link href="" title="Facebook" target="_blank" className="inline-block w-6 mr-2">
                        ...
                        <Link href="https://www.instagram.com/mr_an_283" target="_blank" title="Instagram" className="inline-block w-6 mr-2">
                        ...
                        <Link href="https://www.linkedin.com/in/trannhatan280399" target="_blank" title="LinkedIn" className="inline-block w-6">
